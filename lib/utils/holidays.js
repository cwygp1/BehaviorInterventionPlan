// 0915(mds/33): 기록 달력 '빠진 날' 판정에서 제외할 법정공휴일(대체공휴일·선거일 포함).
// 고정 목록 — 해가 바뀌기 전에 다음 해를 추가할 것. 방학·재량휴업은 P1 일정 기능('기록 쉬는 날')에서 다룬다.
...
export const holidayName = (iso) => HOLIDAYS[iso] || '';
