...
// 기관·포털 링크 — 문서(자료)가 아니라 상시 운영 사이트. 0819 감사에서 교사 지원·영상 강의실에
// 같은 링크가 각각 하드코딩되어 있어(최대 3중복) 이 목록으로 단일화한다.
//   video: 영상 강의실 '공식 자료 포털' 카드에 노출 / support: 교사 지원 '교사 지원 자료' 카드에 노출
export const ORG_PORTALS = [
  {
    id: 'seoul-pbs-portal',
    ...
    icon: '🏛', color: '#4f6bed', video: true, support: true,
  },
  {
    id: 'nise',
    name: '국립특수교육원 (NISE)',
    ...
    icon: '🏫', color: '#0a7d4e', video: true, support: true,
  },
  {
    id: 'eduable',
    name: '에듀에이블 (NISE)',
    ...
    icon: '🎓', color: '#9c36b5', video: true, support: true,
  },
  {
    id: 'hright',
    name: '장애학생 인권보호 지원센터',
    ...
    icon: '🛡', color: '#ef476f', video: true, support: true,
  },
  {
    id: 'onmam',
    ...
    icon: '👨‍👩‍👧', color: '#a76200', video: true, support: true,
  },
];
