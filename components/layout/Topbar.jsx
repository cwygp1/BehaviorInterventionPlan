...
import { SECTIONS, PAGE_SECTION, pageTitle } from '../../lib/tiers';

// 상단 제목은 lib/tiers.js PAGE_META 단일 출처에서 파생한다(0914 P0) — 사이드바 라벨과 항상 같은 이름.
  ...
  return (
    <div className="topbar">
      ...
      <div className="topbar-right">
        <SaveBadge activePage={activePage} />
        <HelpMenu />
