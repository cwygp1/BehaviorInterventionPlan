...
const SEED_MODEL_PRICING = [
  ...
  ['OpenAI', 'GPT-4o', 2.5, 10.0, '', 20],
  ['OpenAI', 'GPT-4o mini', 0.15, 0.6, '경량', 21],
  ['Google', 'Gemini 2.5 Pro', 1.25, 10.0, '≤200k 컨텍스트', 30],
  ['Google', 'Gemini 2.5 Flash', 0.15, 0.6, '', 31],
  ['Google', 'Gemini 2.5 Flash-Lite', 0.1, 0.4, '최저가', 32],
  ['Zhipu', 'GLM-4.6', 0.43, 1.74, '', 40],
  ['Alibaba', 'Qwen3-Max', 1.25, 3.75, '프로모션가', 50],
