...
// 0825(동료 피드백): ②(표적행동 선정·조작적 정의)의 작성 위치를 BIP → 학생 관찰 화면으로 이동.
//   ⑤(가설 설정)는 중재계획(BIP) 화면에 남는다. 단계 제목은 방법론 이름이라 유지.
const STEPS = [
  {
  ...
  {
    n: 2, page: 'observe', icon: '🪄', title: '표적행동의 선정과 조작적 정의',
    desc: '우선순위 1순위 행동을 눈으로 보고 셀 수 있는 구체적 행동으로 정의합니다. — 학생 관찰 화면 「표적행동 조작적 정의」 칸',
